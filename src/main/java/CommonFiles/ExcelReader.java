...
public class ExcelReader {
	...
	public ExcelReader(String testId, String sheetName, String FileName) {
		file = new File(System.getProperty("user.dir") + "/src/main/java/DataFiles/" + FileName + ".xlsx");
		try {
...
//                    cell.setCellType(Cell.CELL_TYPE_STRING);
					if (sheet.getRow(row).getCell(cellNumber).getStringCellValue().equalsIgnoreCase("testCase_ID")) {
