...
public class ExtentManager {
	...
	private static String toMail = ConfigurationReader.gettoMailID();
	static EmailSender mail = new EmailSender();
	...
	public static ExtentReports createInstance() {
		...
		try {
			...
			fileLocation = "ExtentReports" + "/" + getFileName();
	...
	public static void flushReport() {
		extent.flush();
		EmailSender.sendEmail(toMail, "Automated Results Summary", "Check the Report", fileLocation);
	}
